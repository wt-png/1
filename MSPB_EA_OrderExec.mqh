// MSPB_EA_OrderExec.mqh — Order execution helpers: retcode classification, SL/TP modify, position close
// Included by MSPB_Expert_Advisor.mq5
#ifndef MSPB_EA_ORDEREXEC_MQH
#define MSPB_EA_ORDEREXEC_MQH
